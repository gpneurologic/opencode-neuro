export const dict = {
  ...
  "command.session.autoclean": "Wyczy┼¢─ç wyj┼¢cie polece┼ä",
  "command.session.autoclean.description": "Usu┼ä wyj┼¢cie polece┼ä pow┼éoki z historii rozmowy",
  ...
  "toast.session.autoclean.success.title": "Automatyczne czyszczenie zako┼äczone",
  "toast.session.autoclean.success.description": "Usuni─Öto {{count}} blok├│w wyj┼¢cia polece┼ä pow┼éoki",
  "toast.session.autoclean.none.title": "Brak element├│w do wyczyszczenia",
  "toast.session.autoclean.none.description": "Nie znaleziono wyj┼¢cia polece┼ä pow┼éoki w tej sesji",
  "toast.session.autoclean.failed.title": "Automatyczne czyszczenie nie powiod┼éo si─Ö",
  "toast.session.autoclean.failed.description": "Nie uda┼éo si─Ö usun─à─ç wyj┼¢cia polece┼ä pow┼éoki z tej sesji",
