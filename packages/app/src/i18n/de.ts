...
export const dict = {
  ...
  "command.session.autoclean": "Befehlsausgaben bereinigen",
  "command.session.autoclean.description": "Shell-Befehlsausgaben aus dem Gespr├ñchsverlauf entfernen",
  ...
  "toast.session.autoclean.success.title": "Automatische Bereinigung abgeschlossen",
  "toast.session.autoclean.success.description": "{{count}} Shell-Befehlsausgaben entfernt",
  "toast.session.autoclean.none.title": "Nichts zu bereinigen",
  "toast.session.autoclean.none.description": "Keine Shell-Befehlsausgaben in dieser Sitzung gefunden",
  "toast.session.autoclean.failed.title": "Automatische Bereinigung fehlgeschlagen",
  "toast.session.autoclean.failed.description": "Shell-Befehlsausgaben konnten aus dieser Sitzung nicht entfernt werden",
