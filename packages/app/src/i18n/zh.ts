...
export const dict = {
  ...
  "command.session.autoclean": "µ╕àτÉåσæ╜Σ╗ñΦ╛ôσç║",
  "command.session.autoclean.description": "Σ╗ÄΣ╝ÜΦ»¥σÄåσÅ▓Σ╕¡τº╗ΘÖñ shell σæ╜Σ╗ñΦ╛ôσç║",
  ...
  "toast.session.autoclean.success.title": "Φç¬σè¿µ╕àτÉåσ«îµêÉ",
  "toast.session.autoclean.success.description": "σ╖▓τº╗ΘÖñ {{count}} Σ╕¬ shell σæ╜Σ╗ñΦ╛ôσç║σ¥ù",
  "toast.session.autoclean.none.title": "µ▓íµ£ëσÅ»µ╕àτÉåτÜäσåàσ«╣",
  "toast.session.autoclean.none.description": "µ¡ñΣ╝ÜΦ»¥Σ╕¡µ£¬µë╛σê░ shell σæ╜Σ╗ñΦ╛ôσç║",
  "toast.session.autoclean.failed.title": "Φç¬σè¿µ╕àτÉåσñ▒Φ┤Ñ",
  "toast.session.autoclean.failed.description": "µùáµ│òΣ╗Äµ¡ñΣ╝ÜΦ»¥Σ╕¡τº╗ΘÖñ shell σæ╜Σ╗ñΦ╛ôσç║",
