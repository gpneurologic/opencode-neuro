export const dict = {
  ...
  "command.session.autoclean": "Nettoyer la sortie des commandes",
  "command.session.autoclean.description": "Supprimer la sortie des commandes shell de l'historique de la conversation",
  ...
  "toast.session.autoclean.success.title": "Nettoyage automatique termin├⌐",
  "toast.session.autoclean.success.description": "{{count}} blocs de sortie de commandes shell supprim├⌐s",
  "toast.session.autoclean.none.title": "Rien ├á nettoyer",
  "toast.session.autoclean.none.description": "Aucune sortie de commande shell trouv├⌐e dans cette session",
  "toast.session.autoclean.failed.title": "├ëchec du nettoyage automatique",
  "toast.session.autoclean.failed.description": "Impossible de supprimer les sorties de commandes shell de cette session",
