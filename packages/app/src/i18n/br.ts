export const dict = {
  ...
  "command.session.autoclean": "Limpar sa├¡da de comandos",
  "command.session.autoclean.description": "Remover sa├¡da de comandos do shell do hist├│rico da conversa",
  ...
  "toast.session.autoclean.success.title": "Limpeza autom├ítica conclu├¡da",
  "toast.session.autoclean.success.description": "Removidos {{count}} blocos de sa├¡da de comandos do shell",
  "toast.session.autoclean.none.title": "Nada para limpar",
  "toast.session.autoclean.none.description": "Nenhuma sa├¡da de comando do shell encontrada nesta sess├úo",
  "toast.session.autoclean.failed.title": "Falha na limpeza autom├ítica",
  "toast.session.autoclean.failed.description": "N├úo foi poss├¡vel remover a sa├¡da de comandos do shell desta sess├úo",
