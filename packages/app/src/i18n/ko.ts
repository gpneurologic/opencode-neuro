export const dict = {
  ...
  "command.session.autoclean": "δ¬àδá╣ ∞╢£δáÑ ∞áòδª¼",
  "command.session.autoclean.description": "δîÇφÖö Ω╕░δí¥∞ùÉ∞ä£ ∞à╕ δ¬àδá╣ ∞╢£δáÑ ∞á£Ω▒░",
  ...
  "toast.session.autoclean.success.title": "∞₧ÉδÅÖ ∞áòδª¼ ∞Öäδúî",
  "toast.session.autoclean.success.description": "∞à╕ δ¬àδá╣ ∞╢£δáÑ δ╕öδí¥ {{count}}Ω░£δÑ╝ ∞á£Ω▒░φûê∞è╡δïêδïñ",
  "toast.session.autoclean.none.title": "∞áòδª¼φòá φò¡δ¬⌐ ∞ùå∞¥î",
  "toast.session.autoclean.none.description": "∞¥┤ ∞ä╕∞àÿ∞ùÉ∞ä£ ∞à╕ δ¬àδá╣ ∞╢£δáÑ∞¥ä ∞░╛∞¥ä ∞êÿ ∞ùå∞è╡δïêδïñ",
  "toast.session.autoclean.failed.title": "∞₧ÉδÅÖ ∞áòδª¼ ∞ïñφî¿",
  "toast.session.autoclean.failed.description": "∞¥┤ ∞ä╕∞àÿ∞ùÉ∞ä£ ∞à╕ δ¬àδá╣ ∞╢£δáÑ∞¥ä ∞á£Ω▒░φòá ∞êÿ ∞ùå∞è╡δïêδïñ",
