export const dict = {
  ...
  "command.session.autoclean": "╪¬┘å╪╕┘è┘ü ╪Ñ╪«╪▒╪º╪¼ ╪º┘ä╪ú┘ê╪º┘à╪▒",
  "command.session.autoclean.description": "╪Ñ╪▓╪º┘ä╪⌐ ╪Ñ╪«╪▒╪º╪¼ ╪ú┘ê╪º┘à╪▒ ╪º┘ä╪╡╪»┘ü╪⌐ ┘à┘å ╪│╪¼┘ä ╪º┘ä┘à╪¡╪º╪»╪½╪⌐",
  ...
  "toast.session.autoclean.success.title": "╪º┘â╪¬┘à┘ä ╪º┘ä╪¬┘å╪╕┘è┘ü ╪º┘ä╪¬┘ä┘é╪º╪ª┘è",
  "toast.session.autoclean.success.description": "╪¬┘à╪¬ ╪Ñ╪▓╪º┘ä╪⌐ {{count}} ┘â╪¬┘ä╪⌐ ╪Ñ╪«╪▒╪º╪¼ ╪ú┘ê╪º┘à╪▒ ╪╡╪»┘ü╪⌐",
  "toast.session.autoclean.none.title": "┘ä╪º ┘è┘ê╪¼╪» ┘à╪º ┘è┘à┘â┘å ╪¬┘å╪╕┘è┘ü┘ç",
  "toast.session.autoclean.none.description": "┘ä┘à ┘è╪¬┘à ╪º┘ä╪╣╪½┘ê╪▒ ╪╣┘ä┘ë ╪Ñ╪«╪▒╪º╪¼ ╪ú┘ê╪º┘à╪▒ ╪╡╪»┘ü╪⌐ ┘ü┘è ┘ç╪░┘ç ╪º┘ä╪¼┘ä╪│╪⌐",
  "toast.session.autoclean.failed.title": "┘ü╪┤┘ä ╪º┘ä╪¬┘å╪╕┘è┘ü ╪º┘ä╪¬┘ä┘é╪º╪ª┘è",
  "toast.session.autoclean.failed.description": "╪¬╪╣╪░╪▒ ╪Ñ╪▓╪º┘ä╪⌐ ╪Ñ╪«╪▒╪º╪¼ ╪ú┘ê╪º┘à╪▒ ╪º┘ä╪╡╪»┘ü╪⌐ ┘à┘å ┘ç╪░┘ç ╪º┘ä╪¼┘ä╪│╪⌐",
